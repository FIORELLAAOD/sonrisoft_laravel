...
class PagosController extends Controller
{
    ...
    {
        $cit=Cita::Buscar($request->Tratamientos)->orderBy('id','DESC')->paginate(10);
        return view('admin.pagos.index',['viewCitas'=>$cit]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pagos.show',$request->IdCita);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.pagos.detalle',['viewDatos'=>$dtDato,'viewPaciente'=>$dtPaciente,'viewTratemiento'=>$dtTratamiento,'viewMedico'=>$dtMedico]);
    }

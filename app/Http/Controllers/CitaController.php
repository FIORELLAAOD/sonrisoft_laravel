...
class CitaController extends Controller
{
    ...
    {
        $cit=Cita::Buscar($request->Enfermedad)->orderBy('id','DESC')->paginate(10);
        return view('admin.citas.index',['viewCit'=>$cit]);
    }
    ...
    public function calendario(Request $request)
    {
        ...
        return view('admin.citas.calendario',['vLista'=>$lista]);
    }

...
<div class="row" >
    ...
    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
        {!! Form::open(['route'=>'pagosp.index','method'=>'GET']) !!}
    ...
    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
        <a href="{{ route('pagosp.index') }}" class="btn btn-info"><i class="fa fa-refresh"></i></a>
    </div>
    {!! Form::close() !!}
</div> 
                </div>
        ...
        <?php $x=0; ?>
         @foreach($viewCitas as $cit)
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('pagosp.show',$cit->id) }}" class="btn btn-link btn-sm">
